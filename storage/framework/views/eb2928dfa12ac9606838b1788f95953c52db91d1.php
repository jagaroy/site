			...
			<script type="text/javascript">
				$(document).ready(function() {
					$('#search').on('submit', function(event) {
						...
						$.ajax({
							url: '<?php echo e(route('search-history')); ?>',
							type: 'POST',
							dataType: 'json',
							data: data,
						})
			...
			<table class="table table-hover social-accounts"> 
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo e($history->account_name); ?></td>
						<td><?php echo e($history->buffer_postings_post_text); ?></td>
						<td width="10%"><?php echo e($history->buffer_postings_updated_at); ?></td>
					</tr>
